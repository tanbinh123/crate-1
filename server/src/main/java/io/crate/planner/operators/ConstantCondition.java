...
public class ConstantCondition {
    ...
    public static boolean check(Symbol joinCondition) {
    ...
    private static class Context {
        ...
        boolean insideComparisonOperator = false;
        ...
        public Void visitFunction(Function function, ConstantCondition.Context context) {
            ...
            switch (functionName) {
                ...
                case LtOperator.NAME:
                    context.insideComparisonOperator = true;
                    for (Symbol arg : function.arguments()) {
                        arg.accept(this, context);
                    ...
                    break;
                default:
                    if (context.insideComparisonOperator) {
                        for (Symbol arg : function.arguments()) {
                            arg.accept(this, context);
                        }
                    }
